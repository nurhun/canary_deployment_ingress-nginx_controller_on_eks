...
metadata:
  labels:
    grafana_dashboard: "1"
  name: app-nginx-http-request-total
  namespace: prometheus
data:
  app-nginx-http-request-total.json: |-
    {
      "annotations": {
        "list": [
          {
          ...
          "targets": [
            {
              ...
              "editorMode": "builder",
              "expr": "sum by(job) (nginx_http_requests_total{job=\"app/main\"})",
            ...
            },
            {
              ...
              "disableTextWrap": false,
              "editorMode": "builder",
              "expr": "sum by(job) (nginx_http_requests_total{job=\"app/canary\"})",
              "fullMetaSearch": false,
              "hide": false,
              "includeNullMetadata": true,
              "instant": false,
      ...
      "timezone": "",
      "title": "App Dashboard",
      "uid": "c0e842e2-3c63-4b07-bd90-9f47f655b697",
      "version": 2,
      "weekStart": ""
    }
YAML
